...
import EssentialPlanDetails from '@/components/essentialPlanDetails'
...
import EssentialSubscription from '@/components/shared/essentialSubscription';

const EssentialUserProfile = () => {
    ...
    return (
        <div>
            ...
            {activePage == 0 && <EssentialPlanDetails />}
            {activePage == 1 && <EssentialSubscription />}
            {activePage == 2 && <ChangePassword />}
        </div>
    )
}

export default EssentialUserProfile