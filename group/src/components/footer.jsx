...
const Footer = () => {
  return (
    <section className="py-20 bg-[#222B60] mt-5">
      <div className="container">
        <div className="flex md:flex-wrap md:flex-row flex-col gap-y-5 justify-between">
          ...
          <div className="mt-12">
            <ul className="flex flex-col gap-y-4">
              <Link href={'https://coachfinder.app/our-commitment'} >
                <li
        ...
        <div className="border-t border-white mt-10">
          <p className="text-white text-center pt-5">© 2024 CoachFinder . All rights reserved.</p>
        </div>
      </div>
    </section>
  );
