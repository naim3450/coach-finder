...
const EssentialMyGroup = () => {
    ...
    return (
        <div>
            {/* about part start */}
            <div className="container w-full lg:mt-40 mt-60 lg:flex justify-between">
                <div className="">
                    <div className="">
                        <h3 className='font-bold w-full text-primaryColor text-[20px] '>About</h3>
                        <p className='font-medium text-[#97979C] text-[12px] pt-10 w-full lg:w-[750px]'>
                            {userGroup?.about}
                        </p>
                    </div>
                    {/* about end */}
                ...
                <div className="">
                    ...
                    <div className="h-[100px] lg:w-[384px] w-full rounded-[8px] border p-6 mt-5 shadow">
...
export default EssentialMyGroup