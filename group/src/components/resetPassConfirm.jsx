...
export default function ResetPassPage() {
    ...
    const { otp, emailStatus } = useSelector((state) => state.groupInfo);
    ...
    const handleSubmit = async (e) => {
        ...
        if (newPass.newPassword.toLowerCase() == newPass.ConfirmNewPassword.toLowerCase()) {
            setmatchPass(false)
            const chiefObj = Object.assign({}, emailStatus, { verificationCode: otp.verificationCode }, { newPassword: newPass.ConfirmNewPassword })
            try {
                setloading(true)
